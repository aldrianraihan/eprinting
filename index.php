...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">Malendro Printing</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="btn btn-primary-outline ms-3" type="login">Login</a></li>
        </ul>
  ...
  <section id="hero">
    <div class="hero-container">
      <h3>Welcome to <strong>Malendro Putro</strong></h3>
        ...
        <div class="row justify-content-center">
          <div class="col-md-6 col-lg-3 d-flex d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Cetak Dokumen</a></h4>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Cetak Poster</a></h4>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">Cetak Banner</a></h4>
