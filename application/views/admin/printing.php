                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="<?= base_url('c_admin/download/' . $tp->kode) ?>" class="btn btn-primary text-link-white">
                                            <i class="fa-solid fa-download"></i>
                                        </a>
                                        <?php
                                        if ($tp->jenis_cetak == 'dokumen') {
                                        ?>
                                            <a href="<?= base_url('c_admin/edit_printing/' . $tp->kode) ?>" class="btn btn-warning text-link-white">
                                                <i class="fa-solid fa-pen-to-square"></i>
                                            </a>
                                        <?php
                                        }
                                        ?>
                                        <a href="<?= base_url('c_admin/ceklist_print/' . $tp->kode) ?>" class="btn btn-success text-link-white">
